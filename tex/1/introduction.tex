...
\end{equation}
where $n$ is the electron number density, $\nu$ is the frequency of electromagnetic radiation, and $T$ is the temperature. This opacity means low frequencies only become optically thin at low density. For example, microwaves become optically thin in the chromosphere, whereas metric radiation become optically thin typically in the corona at $\sim$0.5$\,R_{\odot}$ above the photosphere.
%Removed to reduce pages
