...
\caption{(Right) A LASCO C2 base-difference image of a CME on 2002 March 22, the yellow line marks the Ultraviolet Coronagraph Spectrometer (UVCS) slit located at CME flank. The event was associated with a type II radio burst. Confirmation of a shock at the slit location was provided by ultraviolet spectroscopy. The O VI and Ly-$\alpha$ lines show a broadening of their tales that is indicative of plasma heating as the shock transits.}
\end{center}
