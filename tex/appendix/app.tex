...
\section{SI and cgs unit conversions}

The following is a list of the conversions between \emph{Syst\`{e}me international} (SI) and centimeter-gram-second (cgs) units commonly used in this thesis.
...
\hline
\hline
\multicolumn{3}{c}{Unit conversions} \\
Quantity & SI Unit & Equivalent cgs unit \\
\hline
Length   & 1\,meter & 10$^{2}$\,centimeters \\
Time      & 1\,second & 1\,second  \\
Mass     &  1\,kilogram & 10$^{3}$\,grams \\
Energy  & 1\,Joule & 10$^7$\,ergs \\
Power   & 1\,Watt  & 10$^{7}$\,ergs\,second$^{-1}$ \\
Force     & 1\,Newton & 10$^5$\,dynes \\
Mag. Field Strength & 1\,Tesla & 10$^{4}$\,Gauss \\
Electric Field Strength & 1\,Volt\,meter$^{-1}$ & $3.34\times10^{-5}$\,statVolt\,centimeter$^{-1}$ \\
\hline
\hline
\end{tabular}
\caption {Relationship between SI and cgs units for quantities used in this thesis.}
\label{tab:SI_cgs}
\end{table}
